...
MD_PATH = 'result_aqlrerm_l_6by6.md'
...
if __name__ == '__main__':
    ...
    with open(MD_PATH, 'w', encoding='utf-8') as md:
        md.write(f'# AQLRERM L-sweep on 6x6 Grid (c={C})\n\n')

        fig, axes = plt.subplots(1, 4, figsize=(24, 5))
        fig.suptitle(f"AQLRERM L-sweep (6x6 Grid, c={C})")
        ...
        plt.tight_layout()
        filename = "result_aqlrerm_l_6by6.png"
