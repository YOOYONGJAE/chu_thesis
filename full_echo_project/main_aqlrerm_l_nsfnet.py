...
MD_PATH = 'result_aqlrerm_l_nsfnet.md'
...
if __name__ == '__main__':
    ...
    with open(MD_PATH, 'w', encoding='utf-8') as md:
        md.write(f'# AQLRERM L-sweep on NSFNET (c={C})\n\n')

        fig, axes = plt.subplots(1, 4, figsize=(24, 5))
        fig.suptitle(f"AQLRERM L-sweep (NSFNET, c={C})")
        ...
        plt.tight_layout()
        filename = "result_aqlrerm_l_nsfnet.png"
